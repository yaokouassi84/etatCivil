...
@ServerEndpoint("/ws/chatListePersonne")
public class ChatWebSocketListePersonne {
	 ...
	 private static final Set<Session> sessions = new CopyOnWriteArraySet<>();
	    ...
	    public void onMessage(String message, Session session) {
	        ...
	        try {
	            ...
	            // Optionnel : Ajouter cette personne à une base de données ou une liste en mémoire
	            // Exemple : personnes.add(personne);  // Ajoute la personne à une liste en mémoire
